    ...
    while epoch < num_epochs:
        ...
        for phase in ['train','val']:
            ...
            for data in dataloaders[phase]:
                ...
                #forward
                outputs,mask_var = model(inputs, labels, epoch)
...
def val_model(model):
    ...
    print('%s top1 Acc:%.4f' % ('val', epoch_acc))
...
if __name__ == '__main__':
    ...
    # # PATH = './tb_dir/cifar_exp/baseline'
    # model_path = os.path.join(args.exp_dir , 'saved_model.pt')
    # load_model = resnet_cifar(depth=args.depth, num_classes=num_classes)
