    ...
    def load_data(self):
        ...
        if self.dataset == 'cifar-10':
            ...
            data_test = datasets.CIFAR10(root=data_dir,
                                         ...
                                         train=False,
                                         download=True)
            data_vis = datasets.CIFAR10(root=data_dir,
                                        transform=data_transforms['vis'],
                                         train=False,
                                         download=True)
        ...
        image_datasets = {'train': data_train, 'val': data_test,'vis':data_vis}
        ...
        dataloaders['val'] = torch.utils.data.DataLoader(image_datasets['val'],
                                                         batch_size=self.batch_size,
                                                         shuffle=False)
        dataloaders['vis'] = torch.utils.data.DataLoader(image_datasets['vis'],
                                                         batch_size=self.batch_size,
                                                         shuffle=False)
