...
from conv_model import Net as conv_net
    ...
    while epoch < num_epochs:
        ...
        for phase in ['train','val']:
            ...
            for data in dataloaders[phase]:
                ...
                outputs,outputs_icnn = model(inputs, labels, epoch)
                loss = 0.3*criterion(outputs, labels) + 0.7 * criterion(outputs_icnn, labels)
